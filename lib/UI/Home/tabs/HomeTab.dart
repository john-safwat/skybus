    ...
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          colors: [
            MyTheme.darkGreen, MyTheme.darkGreen, Colors.white, Colors.white
          ],
          stops: [0 , 0.35  ,0.35 , 1],
        ...
        child: Scaffold(
          body: ListView(
            ...
            children: [
              ...
              Row(
                children: [
                  const Icon(Icons.local_activity  , color: MyTheme.myOrange, size: 35,),
                  const SizedBox(width: 10,),
                  Text("Book" , style: Theme.of(context).textTheme.displayLarge!.copyWith(fontWeight: FontWeight.bold),)
                ],
              ),
                      ...
                      children: [
                        Expanded(
                            child: Container(
                              ...
                              child: Text("One Way" , style: Theme.of(context).textTheme.displayMedium!.copyWith(color: Colors.black),textAlign: TextAlign.center,),
                            )
                        ),
                        ...
                        Expanded(
                            child: Container(
                              ...
                              child: Text("Round Trip" , style: Theme.of(context).textTheme.displayMedium!.copyWith(color: Colors.white),textAlign: TextAlign.center,),
                            )
                        )
                      ],
                    ),
                    ...
                    ElevatedButton(
                      ...
                      child:Padding(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text("Find Your Trip" , style: Theme.of(context).textTheme.displayLarge,),
                          ],
                        ),
                      )
                    ),
              ...
              const SizedBox(height: 10,),
              Row(children: [
                Text("Recent Trips" , style: Theme.of(context).textTheme.displayMedium!.copyWith(color: Colors.black),)
              ],),
              Column(
